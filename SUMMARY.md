...
* [Persistencia y Escalada de Privilegios](red-team-black-hat-proximamente/persistencia-y-escalada-de-privilegios/README.md)
  * [Linux](red-team-black-hat-proximamente/persistencia-y-escalada-de-privilegios/escalada-de-privilegios/linux.md)
    * [Enumeración](red-team-black-hat-proximamente/persistencia-y-escalada-de-privilegios/linux/enumeracion.md)
    * [Service Exploit](red-team-black-hat-proximamente/persistencia-y-escalada-de-privilegios/linux/service-exploit.md)
...
* [Movimiento Lateral](red-team-black-hat-proximamente/movimiento-lateral/README.md)
  * [Lateral Movement](red-team-black-hat-proximamente/movimiento-lateral/lateral-movement.md)
  * [Session Passing](red-team-black-hat-proximamente/movimiento-lateral/session-passing.md)
  * [SOCKS Proxies](red-team-black-hat-proximamente/movimiento-lateral/socks-proxies.md)
  * [Reverse Port Forwards](red-team-black-hat-proximamente/movimiento-lateral/reverse-port-forwards.md)
* [Abuso de Tecnologías Específicas](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/README.md)
  * [DPAPI](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/dpapi.md)
  * [Kerberos](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/kerberos.md)
  * [Group Policy](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/group-policy.md)
  * [SQL](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/sql.md)
  * [MS SQL Server](red-team-black-hat-proximamente/abuso-de-tecnologias-especificas/ms-sql-server.md)
* [Dominio y Trusts](red-team-black-hat-proximamente/dominio-y-trusts/README.md)
  * [Domain Dominances](red-team-black-hat-proximamente/dominio-y-trusts/domain-dominances.md)
  * [Domain & Forest Trusts](red-team-black-hat-proximamente/dominio-y-trusts/domain-and-forest-trusts.md)
* [Bypass de Defensas](red-team-black-hat-proximamente/bypass-de-defensas/README.md)
  * [Bypassing Defences](red-team-black-hat-proximamente/bypass-de-defensas/bypassing-defences.md)
* [Comando y Control (C2)](red-team-black-hat-proximamente/comando-y-control-c2/README.md)
  * [Command & Control](red-team-black-hat-proximamente/comando-y-control-c2/command-and-control.md)
  * [External C2](red-team-black-hat-proximamente/comando-y-control-c2/external-c2.md)
* [Evasión de Defensas y Post-Explotación](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/README.md)
  * [Post-Exploitation Behaviours & Memory Indicators](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/post-exploitation-behaviours-and-memory-indicators.md)
  * [Memory Permissions & Cleanup](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/memory-permissions-and-cleanup.md)
  * [BOF Memory Allocations](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/bof-memory-allocations.md)
  * [Fork and Run Memory Allocations](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/fork-and-run-memory-allocations.md)
  * [SpawnTo](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/spawnto.md)
  * [Process Inject Kit](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/process-inject-kit.md)
  * [PPID Spoofing](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/ppid-spoofing.md)
  * [Command Line Argument Spoofing](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/command-line-argument-spoofing.md)
  * [SMB Named Pipes Names](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/smb-named-pipes-names.md)
  * [Event Tracing for Windows](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/event-tracing-for-windows.md)
  * [Inline (.NET) Execution](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/inline-.net-execution.md)
  * [Tool Signatures](red-team-black-hat-proximamente/evasion-de-defensas-y-post-explotacion/tool-signatures.md)
* [Infraestructura de Comando y Control](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/README.md)
  * [Command and Control (C2)](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/command-and-control-c2.md)
  * [C2 Comparison](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/c2-comparison.md)
  * [Listeners and Communication Channels](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/listeners-and-communication-channels.md)
  * [C2 Comparison](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/c2-comparison-1.md)
  * [Listeners and Communication Channels](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/listeners-and-communication-channels-1.md)
  * [Redirectors](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/redirectors.md)
  * [Third-Party Hosting](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/third-party-hosting.md)
  * [Operational Security](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/operational-security.md)
  * [Understand IoCs](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/understand-iocs.md)
  * [Covenant](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/covenant.md)
  * [VECTR](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/vectr.md)
  * [Getting In and Staying In](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/getting-in-and-staying-in.md)
  * [Attack Infrastructure and Operational Security](red-team-black-hat-proximamente/infraestructura-de-comando-y-control/attack-infrastructure-and-operational-security.md)
* [Explotacion](red-team-black-hat-proximamente/explotacion/README.md)
  * [Weaponization](red-team-black-hat-proximamente/explotacion/weaponization.md)
  * [Custom Executables](red-team-black-hat-proximamente/explotacion/custom-executables.md)
  * [Blending In](red-team-black-hat-proximamente/explotacion/blending-in.md)
  * [Execution Guardrails](red-team-black-hat-proximamente/explotacion/execution-guardrails.md)
  * [Initial Access](red-team-black-hat-proximamente/explotacion/initial-access.md)
  * [Network Propagation](red-team-black-hat-proximamente/explotacion/network-propagation.md)
  * [Discovery](red-team-black-hat-proximamente/explotacion/discovery.md)
  * [Local Network Enumeration](red-team-black-hat-proximamente/explotacion/local-network-enumeration.md)
  * [Local Privilege Escalation](red-team-black-hat-proximamente/explotacion/local-privilege-escalation.md)
  * [Active Directory Attacks and Lateral Movement](red-team-black-hat-proximamente/explotacion/active-directory-attacks-and-lateral-movement.md)
  * [Trees and Forests](red-team-black-hat-proximamente/explotacion/trees-and-forests.md)
  * [Authentication, Authorization, Access Tokens](red-team-black-hat-proximamente/explotacion/authentication-authorization-access-tokens.md)
  * [AD Enumerate](red-team-black-hat-proximamente/explotacion/ad-enumerate.md)
  * [DNS extration](red-team-black-hat-proximamente/explotacion/dns-extration.md)
  * [Domain Privilege Escalation](red-team-black-hat-proximamente/explotacion/domain-privilege-escalation.md)
  * [Access Token Manipulation](red-team-black-hat-proximamente/explotacion/access-token-manipulation.md)
  * [Pass-The-Hash, Pass-The-Ticket](red-team-black-hat-proximamente/explotacion/pass-the-hash-pass-the-ticket.md)
  * [Kerberoasting](red-team-black-hat-proximamente/explotacion/kerberoasting.md)
  * [Silver Ticket, Golden Ticket, Skeleton Key](red-team-black-hat-proximamente/explotacion/silver-ticket-golden-ticket-skeleton-key.md)
  * [AD Certificate Services](red-team-black-hat-proximamente/explotacion/ad-certificate-services.md)
  * [Unconstrained and Constrained Delegation](red-team-black-hat-proximamente/explotacion/unconstrained-and-constrained-delegation.md)
  * [Hopping the Trust](red-team-black-hat-proximamente/explotacion/hopping-the-trust.md)
  * [Trust abuse](red-team-black-hat-proximamente/explotacion/trust-abuse.md)
  * [LLMNR/NBNS/WPAD](red-team-black-hat-proximamente/explotacion/llmnr-nbns-wpad.md)
  * [Bloodhound/SharpHound](red-team-black-hat-proximamente/explotacion/bloodhound-sharphound.md)
  * [AD Explorer](red-team-black-hat-proximamente/explotacion/ad-explorer.md)
  * [SMB Pipes, Remote Desktop Protocol, PsExec, Windows Management Instrumentation, dcom](red-team-black-hat-proximamente/explotacion/smb-pipes-remote-desktop-protocol-psexec-windows-management-instrumentation-dcom.md)
  * [SMB Relay](red-team-black-hat-proximamente/explotacion/smb-relay.md)
  * [LLMNR/NBT-NS Poisoning and Relay](red-team-black-hat-proximamente/explotacion/llmnr-nbt-ns-poisoning-and-relay.md)
  * [Responder](red-team-black-hat-proximamente/explotacion/responder.md)
  * [Setting Up Shadow Credentials](red-team-black-hat-proximamente/explotacion/setting-up-shadow-credentials.md)
  * [Domain Privilege Abuse](red-team-black-hat-proximamente/explotacion/domain-privilege-abuse.md)
  * [DC Sync](red-team-black-hat-proximamente/explotacion/dc-sync.md)
  * [Domain Lateral Movement](red-team-black-hat-proximamente/explotacion/domain-lateral-movement.md)
  * [Domain Trust Attacks](red-team-black-hat-proximamente/explotacion/domain-trust-attacks.md)
  * [Pivoting Between Domains and Forests](red-team-black-hat-proximamente/explotacion/pivoting-between-domains-and-forests.md)
  * [Forest Enumeration, Forest Attacks](red-team-black-hat-proximamente/explotacion/forest-enumeration-forest-attacks.md)
  * [Obtaining the Objective and Reporting](red-team-black-hat-proximamente/explotacion/obtaining-the-objective-and-reporting.md)
  * [Database Attacks](red-team-black-hat-proximamente/explotacion/database-attacks.md)
  * [PowerupSQL](red-team-black-hat-proximamente/explotacion/powerupsql.md)
  * [Target Manipulation](red-team-black-hat-proximamente/explotacion/target-manipulation.md)
  * [Data Staging](red-team-black-hat-proximamente/explotacion/data-staging.md)
...
* [Wireless](pentesting-networks/wireless/README.md)
  ...
  * [Hacking WEP/WPA/WPA2 WIFI Networks](pentesting-networks/wireless/hacking-wep-wpa-wpa2-wifi-networks/README.md)
    ...
    * [Man in the Middle Attacks](pentesting-networks/wireless/hacking-wep-wpa-wpa2-wifi-networks/man-in-the-middle-attacks.md)
